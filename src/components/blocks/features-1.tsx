...
export function Features() {
    return (
        <section id="why-research" className="bg-accent py-16 md:py-24 dark:bg-transparent">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mx-auto mt-10 grid grid-cols-2 gap-x-8 gap-y-8 md:grid-cols-3">
                    <div className="flex items-start gap-3">
                        <GraduationCap className="size-5 mt-0.5 shrink-0 text-primary" />
                        <div>
                    ...
                    <div className="flex items-start gap-3">
                        <FlaskConical className="size-5 mt-0.5 shrink-0 text-primary" />
                        <div>
                    ...
                    <div className="flex items-start gap-3">
                        <FileText className="size-5 mt-0.5 shrink-0 text-primary" />
                        <div>
                    ...
                    <div className="flex items-start gap-3">
                        <Award className="size-5 mt-0.5 shrink-0 text-primary" />
                        <div>
